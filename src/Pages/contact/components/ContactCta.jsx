      ...
      <section className="mt-[8px] lg:mt-[8px] px-10">
        <div className="bg-linear-to-r from-white02 to-gray rounded-[25px] grid grid-cols-1 xl:grid-cols-[2fr_3fr] ">
          <div className="py-2 lg:py-[80px] pl-8 px-6 xl:pl-[100px] ">
            <h3 className="font-semibold font-poppins text-[18px] md:text-2xl lg:text-4xl text-black mb-6">
              Get Up-to-Date Gadget Technology
            </h3>
            <p className="font-normal font-montserrat text-[16px] md:text-[18px] lg:text-xl text-black mb-8">
              Browse our wide selection of electronics and find the perfect
              promo for you from newsletter.
            </p>

            <CommonButton className="!bg-orange md:!mt-[16px] !px-4 md:!px-8 !h-10 md:!h-12 !border-none rounded-[10px] !mx-[25%] lg:!mx-[40px] xl:!mx-0">
              <span className="font-bold font-montserrat text-[14px] md:text-[18px] lg:text-lg text-white">
                {t("Subscribe")}
              </span>
            </CommonButton>
          </div>
