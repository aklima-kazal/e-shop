    ...
    <>
      <div className=" w-fit mb-8 lg:mb-0">
        <div className="bg-orange p-6 rounded-[10px] items-center">
          <h3 className="font-semibold font-poppins text-xl md:text-2xl text-white mb-4">
            Blog Search
          </h3>

          <div className="flex items-center border-2 border-white01 px-2 lg:px-[18px] py-[10px] rounded-lg max-w-[332px] min-w-[200px] bg-white">
            <input
              placeholder={t("Search_Products_...")}
              type="search"
              className="outline-none bg-white "
            />
            <IoIosSearch size={25} className="hidden lg:block" />
          </div>
        </div>
